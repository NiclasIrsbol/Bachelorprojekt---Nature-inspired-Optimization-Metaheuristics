...
Usage:
    cd backend
    python3 -m optimization_framework.experiments.legacy_aco.mmas_leadingones_rho
    python3 -m optimization_framework.experiments.legacy_aco.mmas_leadingones_rho --sizes 20 40 --seeds 2 --max-iterations 50000
"""
